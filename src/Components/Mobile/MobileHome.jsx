...
export default function MobileHome() {
  ...
  return (
    ...
    <LoadScript
      googleMapsApiKey="AIzaSyDobn-D4ndPtHUStpfpRC9uvBrJNW8C7qA"
    >
      <GoogleMap
    ...
    <form>
      <div className="card-img-overlay" style={{position: "relative",top: "-33rem"}}>
        <input
          type=""
    ...
    <div className='confirm-booking' style={{ marginTop: "-8.5rem" }}>
          <a className="btn btn-danger text-white rounded-pill w-100" href="/MobileBookCabs">
            Confirm Booking
          </a>
    </div>
    </div>
    ...
    <div className="booking-area py-5" style={{ marginTop: "40px", backgroundColor: "white"}}>
      <div className="container">
    ...
    <div className="row">
      <div className="col-md-6 col-lg-4">
        <div className="rate-item wow fadeInUp" data-wow-delay=".25s">
          ...
          <div className="rate-header-content" style={{margin:"30px 0 30px" }}>
            <h4>Basic Pakage</h4>
          ...
          <div className="rate-content" >
            <div className="rate-feature">
              <ul>
                ...
                <li>
                  <i className="far fa-check-double" /> Distance Allowance:{" "}
                  <span>5000m</span>
                </li>
                <li>
      ...
      <div className="col-md-6 col-lg-3">
        <div className="feature-item wow fadeInUp" data-wow-delay=".25s">
          ...
          <div className="feature-content">
            ...
            <p>
              There are many variations of majority have suffered alteration in
              some form injected humour randomised words.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="taxi-item">
          ...
          <div className="taxi-content">
            <div className="taxi-head">
              <h4>AURA</h4>
              <p className=''>Hyundai Aura for a driver around the city at your services</p>
              <span>12/km</span>
            </div>
            <a href="#" className="theme-btn">
              Contact
            ...
            <div className="choose-item ms-lg-5">
              <div className="choose-item-info">
                ...
                <p>
                  There are many variations of passages available but the majority
                  have suffered alteration in form injected humour words which
                  even slightly believable. If you are going passage you need
                  there anything.
                </p>
              </div>
            </div>
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                pulvinar turpis erat ac elit eu orci id odio facilisis pharetra.
              </div>
            </div>
          </div>
          <div className="accordion-item">
