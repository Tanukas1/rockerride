...
import MobileGetCabs from './MobileGetCabs';
            ...
            <div className={`sidebar ${isOpen == true ? 'active' : ''}`}>
                <div className="sd-header">
                    <a className="navbar-brand">
                      <img src="assets/img/mobile/profile.jpg" class="rounded-circle" style={{width: "40px"}}/>
                ...
                <div className="sd-body">
                    ...
                    <li><a className="nav-link" href="/">
                              <div class="row">
                                <div class="col-2"><i class="bi bi-car-front-fill text-danger"></i></div>
                                <div class="col-8">Home</div>
                                <div class="col-2"><i class="bi bi-caret-right-fill"></i></div>
                              </div>
                            </a>
                          </li>
                          <li><a className="nav-link" href="/get-caps">
                              <div class="row">
                                <div class="col-2"><i class="bi bi-car-front-fill text-danger"></i></div>
                          ...
                          <li><a className="nav-link" href="/services">
                              <div class="row">
                                <div class="col-2"><i class="bi bi-car-front-fill text-danger"></i></div>
                          ...
                          <li><a className="nav-link" href="/about">
                              <div class="row">
                                <div class="col-2"><i class="bi bi-car-front-fill text-danger"></i></div>
                          ...
                          <li><a className="nav-link" href="/Contact">
                              <div class="row">
                                <div class="col-2"><i class="bi bi-car-front-fill text-danger"></i></div>
